...
import static org.firstinspires.ftc.teamcode.constants.autoConstants.BLUE_CLOSE_FIRE_TURRET_LAST;
        ...
        CommandScheduler.getInstance().schedule(
                new SequentialCommandGroup(
                        ...
                        new ParallelCommandGroup(
                                new FollowPathCommand(follower.follower, bluePathChains.getCLOSE_INTAKE_SECOND_ROW_CHAIN()),
                                new SequentialCommandGroup(
                                        new WaitCommand(150),
                        ...
                        new ParallelCommandGroup(
                                ...
                                new FollowPathCommand(follower.follower, bluePathChains.getCLOSE_INTAKE_GATE_CHAIN(), true),
                                new SequentialCommandGroup(
                                        new WaitCommand(200),
                                        new InstantCommand(() -> robot.intake.intakeIn())
                                )
                        ...
                        new InstantCommand(() -> robot.shooter.turretToDegree(BLUE_CLOSE_FIRE_TURRET)),
                        new ParallelCommandGroup(
                                new DriveCurrentToPoint(follower, BLUE_CLOSE_SHOOT_CONTROL, BLUE_CLOSE_SHOOT_INTAKE_GATE),
                                new SequentialCommandGroup(
                                        new WaitCommand(150),
                                        new InstantCommand(() -> robot.intake.intakeStop())
                                )
                        ...
                        // intake 1st row
                        new ParallelCommandGroup(
                                new FollowPathCommand(follower.follower, bluePathChains.getCLOSE_INTAKE_FIRST_ROW_CHAIN()),
                                new SequentialCommandGroup(
                                        new WaitCommand(100),
                                        new InstantCommand(() -> distance = CLOSE_FIRE_DISTANCE_LAST),
                                        new InstantCommand(() -> robot.shooter.turretToDegree(BLUE_CLOSE_FIRE_TURRET_LAST)),
                                        new InstantCommand(() -> robot.intake.intakeIn())
                                )
                        ),
                        new InstantCommand(() -> robot.intake.intakeStop()),
