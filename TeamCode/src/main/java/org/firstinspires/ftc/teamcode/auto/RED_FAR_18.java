...
@Autonomous
public class RED_FAR_18 extends OpMode {
    ...
    public void start() {
        ...
        CommandScheduler.getInstance().schedule(
                new SequentialCommandGroup(
                        ...
                        new DriveCurrentToPoint(follower, RED_FAR_INTAKE_THIRD_CONTROL, RED_FAR_INTAKE_THIRD_END),
                        new InstantCommand(() -> robot.intake.intakeStop()),

                        // 发射第三排
                        new DriveCurrentToPoint(follower, RED_FAR_SHOOT),
                        new InstantCommand(() -> robot.intake.gateOpen()),
                        new InstantCommand(() -> robot.intake.intakeFire(FAR_FIRE_INTAKE_POWER)),
                        new WaitCommand(TOTAL_SHOOT_TIME),
                        new InstantCommand(() -> robot.intake.gateClose()),
                        ...
                        new ParallelRaceGroup(
                                ...
                                new SequentialCommandGroup(
                                    new DriveCurrentToPoint(follower, RED_FAR_INTAKE_HP_1_START),
                                    new DriveCurrentToPoint(follower, RED_FAR_INTAKE_HP_1_MID),
                                    new DriveCurrentToPoint(follower, RED_FAR_INTAKE_HP_1_END)
                                )
                        ),
                        new InstantCommand(() -> robot.intake.intakeStop()),
                        new DriveCurrentToPoint(follower, RED_FAR_SHOOT_HP),
                        new InstantCommand(() -> robot.intake.gateOpen()),
                        new InstantCommand(() -> robot.intake.intakeFire(FAR_FIRE_INTAKE_POWER)),
                        new WaitCommand(TOTAL_SHOOT_TIME),
                        new InstantCommand(() -> robot.intake.gateClose()),
                        ...
                        // 停靠
                        new DriveCurrentToPoint(follower, RED_FAR_PARK),
