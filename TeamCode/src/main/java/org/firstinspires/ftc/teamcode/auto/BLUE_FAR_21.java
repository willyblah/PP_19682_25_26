...
import static org.firstinspires.ftc.teamcode.constants.autoConstants.AUTO_FAR_WAIT_FOR_SHOOT;
import static org.firstinspires.ftc.teamcode.constants.autoConstants.FAR_FIRE_DISTANCE;
import static org.firstinspires.ftc.teamcode.constants.autoConstants.FAR_FIRE_DISTANCE_PRELOAD;
import static org.firstinspires.ftc.teamcode.constants.autoConstants.FAR_HOLD_DISTANCE;
...
import static org.firstinspires.ftc.teamcode.constants.autoConstants.BLUE_FAR_TURRET;
import static org.firstinspires.ftc.teamcode.constants.autoConstants.BLUE_FAR_TURRET_PRELOAD;
...
@Autonomous
public class BLUE_FAR_21 extends OpMode {
    ...
    public void start() {
        ...
        CommandScheduler.getInstance().schedule(
                new SequentialCommandGroup(
                        ...
                        new WaitCommand(AUTO_FAR_WAIT_FOR_SHOOT + 800),
                        ...
                        new InstantCommand(() -> distance = FAR_HOLD_DISTANCE),

                        // intake 3rd row
                        new ParallelCommandGroup(
                                new FollowPathCommand(follower.follower, bluePathChains.getFAR_INTAKE_THIRD_ROW_CHAIN()),
                                new SequentialCommandGroup(
                                        new WaitCommand(200),
                        ...
                        // shoot 3rd row
                        new InstantCommand(() -> distance = FAR_FIRE_DISTANCE),
                        ...
                        new ParallelRaceGroup(
                                ...
                                new ParallelCommandGroup(
                                        new FollowPathCommand(follower.follower, bluePathChains.getFAR_INTAKE_HP_1_CHAIN()),
                                        new SequentialCommandGroup(
                                                new WaitCommand(300),
                                                new InstantCommand(() -> robot.intake.intakeIn())
                                        )
                        ...
                        new InstantCommand(() -> robot.shooter.turretToDegree(BLUE_FAR_TURRET)),
                        new ParallelCommandGroup(
                                new DriveCurrentToPoint(follower, BLUE_FAR_SHOOT_HP).setHoldEnd(true),
                                new SequentialCommandGroup(
                                        new WaitCommand(700),
                                        new InstantCommand(() -> robot.intake.intakeStop())
                                )
                        ...
                        new ParallelRaceGroup(
                                new WaitCommand(1800),
                                new ParallelCommandGroup(
                                        new FollowPathCommand(follower.follower, bluePathChains.getFAR_INTAKE_TUNNEL_CHAIN(), true),
                                        new SequentialCommandGroup(
                                                new WaitCommand(300),
                                                new InstantCommand(() -> robot.intake.intakeIn())
                                        )
                        ...
                        new InstantCommand(() -> robot.shooter.turretToDegree(BLUE_FAR_TURRET)),
                        new ParallelCommandGroup(
                                new DriveCurrentToPoint(follower, BLUE_FAR_SHOOT_TUNNEL).setHoldEnd(true),
                                new SequentialCommandGroup(
                                        new WaitCommand(200),
                                        new InstantCommand(() -> robot.intake.intakeStop())
                                )
                        ...
                        // park
                        new DriveCurrentToPoint(follower, BLUE_FAR_PARK).setHoldEnd(true).setMaxPower(1),
